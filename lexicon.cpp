...
{
    if (sizeof(int) != 4) {
	string msg = "Lexicon assumes the int type is 4 bytes. On this system the size is " + sizeof(int);
	Error(msg);
    }
    edges = start = NULL;
...
/*
************************************************************************************
* Iterator implementation, based on foreach.h
*
*    W A R N I N G !!!!!!
*
* This implementation is at the seems-to-work-but-I-don't-understand-why stage.
* Use with caution, and feel encouraged to rewrite it if you can do it better!
*    (Colin, Sept 2011)
*
***********************************************************************************
*/
 ...
 * it possible to freeing the iterators after they are no inter needed.
 *
 */
