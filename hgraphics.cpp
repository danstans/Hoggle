...
static colorEntryT colorTable[] = {
    ...
    {"HexColor",    0.90*255, 0.90*255, 0.70*255},     /* almost white    */
    {"LetterColor", 0.01*255, 0.20*255, 0.85*255},     /* dark blue       */
    {"WordColor",   0.01*255, 0.30*255, 0.30*255},     /* med green-blue  */
    {"LabelColor",  0.01*255, 0.45*255, 0.25*255},     /* dark green-blue */
    {"MessageColor",  0.01*255, 0.35*255, 0.15*255},
};
...
static void DrawDie(int row, int col, char ch, bool highlight)
{
    ...
    string lettercolor = (highlight) ? "HexColor" : "LetterColor";
